...
//				hvacLoadType.LatentHeatGainPerPerson = 221.00;
				...
				RevitCommandId id = RevitCommandId.LookupPostableCommandId(PostableCommand.CreateEnergyModel);
				PostCommand(id);
...
//				TaskDialog.Show("WeatherFile", "Weather file name is " + weatherFileName);
				...
				// Find an existing 3D view named 'Analytical Spaces' or create a new one
			    View3D view3D = new FilteredElementCollector(doc)
			        .OfClass(typeof(View3D))
			        .Cast<View3D>()
			        .FirstOrDefault(v => v.Name == "Analytical Spaces");
			    
//			    foreach (var space in spaces)
//			    {
//			        ElementId spaceId = space.Id;
//			        Element spaceElement = doc.GetElement(spaceId);
//			
//			        if (spaceElement != null)
//			        {
//			            WorksetId worksetId = spaceElement.WorksetId;
//			            // Do something with the worksetId, e.g., print it
//			            //TaskDialog.Show("Workset Info", $"Space Name: {space.Name}\nWorkset ID: {worksetId.IntegerValue}");
//			            view3D.SetWorksetVisibility(worksetId, WorksetVisibility.Visible);
//			        }
//			    }
		...
		public void addAnalyticView()
		{
	        ...
	        using (Transaction trans = new Transaction(doc, "Create Analytical 3D View"))
	        {
	            trans.Start();
	            ...
	            {
	            	TaskDialog.Show("viewFamilyType == null", "viewFamilyType == null");
	            }
	            ...
	            if (view3D == null)
	            {
	            	TaskDialog.Show("view3D == null", "view3D == null");
	            }
	
	            // Set the analytical model display
//	            view3D.ana = DisplayStyle.Analytical;
//	            SetAnalyticalModelVisibility(doc, view3D);
