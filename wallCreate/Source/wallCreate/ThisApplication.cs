	...
	public partial class ThisApplication
	{
		...
		public void createWall()
		{
			...
			using (Transaction transaction = new Transaction(doc))
			{
				...
				AnalyticalMember anayticalMember = AnalyticalMember.Create(doc, line);
				anayticalMember.StructuralRole = AnalyticalStructuralRole.StructuralRoleBeam;
		...
		public void addCeiling()
		{
			...
			using (Transaction trans = new Transaction(doc))
			{
				...
				try
				{
					IEnumerable<Space> spaces = new FilteredElementCollector(doc, doc.ActiveView.Id).WhereElementIsNotElementType()
